...
public class PutJenisActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_put_jenis);
        initLayut();
        ...
        btnTambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                putJenis(edtNama.getText().toString(),
    ...
    private void putJenis(String nama, String kode, String keterangan) {
        if(!nama.isEmpty() && !kode.isEmpty()) {
            Call<String> call = userService.putJenis(id,nama,kode,keterangan);
            call.enqueue(new Callback<String>() {
                @Override
                public void onResponse(Call<String> call, Response<String> response) {
                    Toast.makeText(PutJenisActivity.this, response.body(), Toast.LENGTH_SHORT).show();
                }

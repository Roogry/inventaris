...
--
-- Host: 127.0.0.1
-- Generation Time: 11 Apr 2019 pada 07.01
...
(1, 'Laptop', 2, 'Barang Pakai Habis', 30, 2, '2019-04-04 08:46:04', 13, 'IS0001', 1),
(6, 'Mouse', 2, 'Barang Pinjam', 50, 2, '2019-04-06 03:20:11', 15, 'IS0006', 1),
(8, 'Kursi', 1, 'Barang Pakai Habis', 98, 4, '2019-04-08 05:59:50', 2, 'IS0007', 1),
(9, 'Test1', 3, 'Barang Pinjam', 10, 3, '2019-04-11 04:34:34', 2, 'IS0009', 1),
(10, 'Test2', 2, 'Barang Pakai Habis', 10, 4, '2019-04-11 04:37:44', 4, 'IS0010', 1);
...
INSERT INTO `peminjam` (`id_peminjam`, `nama_peminjam`, `nip_nis`, `username`, `password`, `alamat`, `status_peminjam`) VALUES
(1, 'Jodie Mantra', '201953258956', 'jo', 'pass', 'Jl. Perum Bina Permai II / No.52', 1),
(2, 'Venny Sukma', '', 've', 'pass', 'Jl. Ayani No. 129', 3),
(7, 'Cikal Taruna', '', 'ci', 'pass', 'Jl. Kapten Japa No.100', 2);
...
(16, '2019-04-11 01:12:39', '0000-00-00 00:00:00', 1, 7, 'PN12438659'),
(17, '2019-04-11 01:13:53', '0000-00-00 00:00:00', 1, 1, 'PN67483925');
...
--
ALTER TABLE `detail_pinjam`
  MODIFY `id_detail_pinjam` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `inventaris`
--
ALTER TABLE `inventaris`
  MODIFY `id_inventaris` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `peminjaman`
  MODIFY `id_peminjaman` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `ruang`
  MODIFY `id_ruang` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
